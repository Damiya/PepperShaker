class ConvertChampBoolsToInts < ActiveRecord::Migration
  def up
  ...
  def down
    ...
    remove_column :champions, :has_fakes
    remove_column :champions, :bad_ai
    add_column :champions, :gets_hitboxed, :boolean
    add_column :champions, :undersized_hitbox, :boolean
    add_column :champions, :oversized_hitbox, :boolean
    add_column :champions, :zoning, :boolean
    add_column :champions, :rushdown, :boolean
    add_column :champions, :one_hit_knockout, :boolean
    add_column :champions, :doesnt_super, :boolean
    add_column :champions, :high_health, :boolean
    add_column :champions, :low_health, :boolean
    add_column :champions, :high_damage, :boolean
    add_column :champions, :low_damage, :boolean
    add_column :champions, :grappler, :boolean
    add_column :champions, :grapple_immune, :boolean
    add_column :champions, :flies, :boolean
    add_column :champions, :heals, :boolean
    add_column :champions, :timescammer, :boolean
    add_column :champions, :has_fakes, :boolean
    add_column :champions, :bad_ai, :boolean
  end
end
